...
<h3 class="text-secondary px-2" style="background-color: #fcd5c9">AREAS</h3>

@stop
@section('content')
<div class="container col-md-10 mt-4">
    <div class="w-100 bg-admin-card-title p-1">
        <a href="{{ route('areas.create') }}" class="text-white text-decoration-none font-gothamBold "> 
            +
            NUEVA AREA
        </a>
    </div>
    ...
    {{ $areas->links('pagination::simple-bootstrap-5') }}
    <table class="table table-striped table-hover table-borderless">
        ...
        <tbody>
            @forelse ($areas as $area)
                <tr class="m-2">
                    <td>
                        <a href="{{ route('areas.edit', $area) }}" class="btn btn-outline-primary rounded-pill">Editar</a>
