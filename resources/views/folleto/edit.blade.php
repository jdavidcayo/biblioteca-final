    ...
    <div class="row flex justify-content-center mt-4">
        <div class="col-md-10">
            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('folletos.update', $folleto->id) }}"  role="form" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="box box-info padding-1">
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name='titulo' class="form-control" placeholder="Titulo" required value="{{$folleto->titulo}}" maxlength="254">
                                </div>
                                
                                <div class="form-group d-flex flex-col justify-content-between mt-4">
                                    <div class="item-fecha">
                                        <label class="text-secondary">Fecha</label>
                                        <input type="date" name='fecha' class="form-control" placeholder="Fecha" value="{{ $folleto->fecha }}">
                                    </div>
                                    <div class="item-estado">
                                        <label class="text-secondary">Estado</label>
                                        <select name="estado" id="idSelect" class="form-control" value="{{ $folleto->estado }}">
            
                                            <option value="1" @if ($folleto->estado == 1)
                                                selected="selected" @endif>Activo</option>
                                            <option value="0" @if ($folleto->estado == 0)
